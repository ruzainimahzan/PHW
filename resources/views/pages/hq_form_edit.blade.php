    ...
    <div class="wrapper">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#therapist-attendance" data-toggle="tab">Attendance</a></li>
                <li><a href="#therapist-soap" data-toggle="tab">S-O-A-P</a></li>
                <li><a href="#therapist-ortho" data-toggle="tab">Orthopaediac Form</a></li>
            ...
            <div class="tab-content">
                <div class="tab-pane" id="therapist-ortho">
            ...
            <div class="tab-pane" id="therapist-jointmovement">
                                        ...
                                        <td>
                                            <center>
                                             <!--    <a href="#" class="btn btn-info btn-sm open-editvitalsign" data-toggle="modaledit" data-target="#editvitalsign" data-userid="{{ $list->id_movement_joint }}"><i class="fa fa-edit"></i></a> -->
                                                <a href="#" data-id="{{ $list->id_movement_joint }}" class="joints-remove_hq"><button href="" type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></a>
                                            </center>
                                        </td>
                                    </tr>
                                    @endforeach
                ...
                <!-- /.box-body -->
                <form method="post" action="{{URL::route('add_joint_movement_hq')}}" id="form">
                    @csrf
            ...
            <div class="tab-pane active" id="therapist-attendance">
                <div class="box box-primary">
                    <!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <tbody>
                                @if( $queryattendance != null )
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <a href="#" data-id="{{ $list->id_treatment }}" class="attendance-remove_hq"><button href="" type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></a>
                                            </center>
                                        </td>
                                    </tr>
                                    @endforeach
                ...
                <!-- /.box-body -->
                <form method="post" action="{{URL::route('add_attendance_hq')}}" id="form">
                    @csrf
                    <div class="modal fade" id="addattendance" tabindex="-1" role="dialog" aria-labelledby="addstaffLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <input type="hidden" name="user_id" id="user_id" value="@if($detailspatient != null){{$detailspatient->ic_patients}}@endif">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title" 
            ...
            <div class="tab-pane" id="therapist-soap">
                        ...
                        <table id="" class="table table-bordered table-striped display nowrap display nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a href="#" data-id="{{ $list->id_summary_diagnose }}" class="method-remove_hq"><button href="" type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></a>
                                        </center>
                                    </td>
                                </tr>
                                @endforeach
                ...
                <form method="post" action="{{URL::route('add_methodsoap_hq')}}" id="methodform">
                    @csrf
                    ...
                    <table id="table-ortho" class="table table-bordered table-striped display nowrap display nowrap">
                        ...
                        <tbody>
                         ...
                         <tr>
                            ...
                            <td>
                                <center>
                                    <a href="#" data-id="{{ $list->id_report_diagnose }}" class="report-remove_hq"><button href="" type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></a>
                                </center>
                            </td>
                        </tr>
                        @endforeach
        ...
        <form method="post" action="{{URL::route('add_simplereport_hq')}}" id="reportform">
            @csrf
