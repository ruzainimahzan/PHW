      ...
      <section class="content">
        ...
        <div class="row" class="">
          ...
          <div class="col-md-12">
           ...
           <div class="col-md-3 ">
            <a href="{{ url('hq_form') }}" class="btn btn-primary btn-lg">
             Add Diagnose
           </a>
         </div>
              ...
              <table id="example1" class="table table-bordered table-striped display nowrap display nowrap display nowrap">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>0</td>
                    <td>
                      <a href="{{ route('hq_edit', $tl->id_diagnose) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
