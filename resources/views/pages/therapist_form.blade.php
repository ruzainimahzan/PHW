                ...
                <div class="row" class="">
                    ...
                    <div class="col-sm-10 col-sm-push-1">
                        ...
                        <section class="col-lg-12">
                            <br/>
                            <form class="form-horizontal" id="find_patient_form" method="post" action="{{URL::route('find_patient')}}"> 
                                @csrf
                                <div class="row">
                                   <div class="col-md-12 form-group">
                                    <label class="col-lg-5 control-label" >Keywords(IC / Phone Number)</label>
                                    <div class="col-md-3" >
                        ...
                        @csrf
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <select class="form-control" name="id_type_session" id="id_type_session" >
                                    ...
                                    <option value="{{ $lst->id_type_sessions }}">{{ $lst->name_type_sessions }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 form-group">
                                <label class="col-sm-4 control-label">Price Session</label>
                                <div class="col-sm-8">
                                <input type="text" class="form-control" id="price_session" name="price_session" >
                                </div>
                            </div>
                          <!--   <div class="col-sm-6 form-group">
                                <label class="col-sm-4 control-label">Total Session</label>
